...
(define (make-parser)
  ...
  (last-stmt (break) : '(break)
             (return) : '(return) ; is it proper to return *unspecified* 
             (return exp-list1) : `(return ,$1))
  ...
  (function-call (prefix-exp args) : `(function-call ,$1 ,$2)
                 (prefix-exp colon name args) : `(function-call ,$1
